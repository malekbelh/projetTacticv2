...
function FooterHome() {
  return (
    <footer className="bg-[#212177] py-14  flex flex-wrap flex-row items-start justify-around  text-white ">
      ...
      <div className="bloc3 flex flex-col pt-10 items-center justify-start gap-[59px_0px]">
        ...
        <div className="w-[173px] flex flex-row items-start justify-start px-6 ">
